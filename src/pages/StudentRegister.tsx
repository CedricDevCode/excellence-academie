  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-primary-500 to-primary-600 flex items-center justify-center p-4">
      <div className="w-full max-w-2xl">
        <Link to="/" className="flex items-center gap-2 text-primary-200 hover:text-white mb-6 transition-colors text-sm" aria-label="Retour à l'accueil">
          ...
          <div className="bg-linear-to-r from-primary-500 to-primary-600 p-6 text-white">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-primary-200 text-sm">Rejoignez 500+ étudiants qui réussissent</p>
              </div>
            </div>
          </div>
