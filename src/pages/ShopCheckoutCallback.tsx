      ...
      <div className="max-w-md w-full bg-white rounded shadow-xl p-8 text-center">
        {status === 'verifying' ? (
          <div>
            ...
            <h2 className="text-2xl font-bold text-[#7a4b00] mb-2">Vérification...</h2>
            <p className="text-gray-600">Veuillez patienter pendant que nous confirmons votre paiement.</p>
          </div>
        ) : status === 'success' ? (
          <div>
            <CheckCircle className="w-20 h-20 text-green-500 mx-auto mb-6" />
            <h2 className="text-3xl font-bold text-[#7a4b00] mb-4">Commande Réussie !</h2>
            ...
            <div className="flex flex-col gap-3">
              <Link
                to="/student/login"
                className="inline-flex items-center justify-center gap-2 w-full py-4 px-6 bg-primary-600 hover:bg-primary-700 text-white rounded font-bold transition-all"
              >
                <ShoppingBag size={18} /> Suivre ma commande
              </Link>
              <Link
                to="/"
                className="inline-block w-full py-4 px-6 border-2 border-[#7a4b00] text-[#7a4b00] hover:bg-[#7a4b00] hover:text-white rounded font-bold transition-all"
              >
                Retour à l'accueil
              </Link>
            </div>
          ...
          <div>
            ...
            <h2 className="text-3xl font-bold text-[#7a4b00] mb-4">Paiement Échoué</h2>
            <p className="text-gray-600 mb-8 text-lg">
            ...
            <div className="flex flex-col gap-3">
              <Link
                to="/shop"
                className="inline-block w-full py-4 px-6 bg-primary-600 hover:bg-primary-700 text-white rounded font-bold transition-all"
              >
