          ...
          <div className="prose prose-sm max-w-none text-gray-700 space-y-6">
            ...
            <section>
              ...
              <p>
                ...
                Site web : <a href="https://www.hostinger.com" target="_blank" rel="noopener noreferrer" className="text-[#0056B3] hover:underline">www.hostinger.com</a>
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Consultez notre <Link to="/politique-de-confidentialite" className="text-[#0056B3] hover:underline">Politique de Confidentialité</Link> pour plus de détails.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                <Link to="/preferences-cookies" className="text-[#0056B3] hover:underline"> Paramètres des cookies</Link>.
              </p>
            </section>
