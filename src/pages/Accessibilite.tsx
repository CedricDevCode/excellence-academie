          ...
          <div className="prose prose-sm max-w-none text-gray-700 space-y-6">
            ...
            <section>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 my-4">
                <div className="flex items-start gap-3 p-4 bg-gray-50 rounded border border-gray-100">
                  <Eye size={20} className="text-[#c97e00] shrink-0 mt-0.5" />
                  <div>
                ...
                <div className="flex items-start gap-3 p-4 bg-gray-50 rounded border border-gray-100">
                  <Keyboard size={20} className="text-[#c97e00] shrink-0 mt-0.5" />
                  <div>
                ...
                <div className="flex items-start gap-3 p-4 bg-gray-50 rounded border border-gray-100">
                  <Monitor size={20} className="text-[#c97e00] shrink-0 mt-0.5" />
                  <div>
                ...
                <div className="flex items-start gap-3 p-4 bg-gray-50 rounded border border-gray-100">
                  <Volume2 size={20} className="text-[#c97e00] shrink-0 mt-0.5" />
                  <div>
