...
export default function TestimonialsView() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded p-6 shadow-sm border border-gray-100 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div>
        ...
        <div className="flex items-center gap-3 w-full md:w-auto">
          <div className="flex items-center gap-2 bg-gray-50 px-3 py-1.5 rounded border border-gray-200 text-xs font-bold text-gray-600">
          ...
          <button
            onClick={openCreate}
            className="flex-1 md:flex-none flex items-center justify-center gap-2 px-4 py-2.5 bg-gradient-to-r from-[#f5a623] to-[#a36200] text-white font-bold rounded hover:brightness-105 transition-all shadow-sm shadow-primary-500/20 text-sm whitespace-nowrap"
          >
            <Plus size={18} />
      ...
      {/* Form Drawer / Card */}
      {showForm && (
        <div className="bg-white rounded shadow-xl border-2 border-primary-200 overflow-hidden animate-fadeIn">
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-5">
                ...
                <div className="flex items-center gap-1.5 mt-2 flex-wrap text-[11px]">
                  ...
                  {["Admis Magistrature 2023", "Admis ENA 2024", "Admis Greffe 2024", "Admis Agent pénitentiaire 2023"].map(sug => (
                    <button
                      ...
                      className="px-2 py-0.5 bg-surface-50 hover:bg-primary-50 hover:text-primary-600 rounded-md text-gray-600 font-medium transition-colors"
                    >
                      {sug}
                    </button>
                  ))}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 pt-2">
              <div>
                ...
                <div className="flex items-center gap-4">
                  <div className="w-16 h-16 rounded bg-surface-50 border-2 border-dashed border-gray-300 overflow-hidden shrink-0 flex items-center justify-center relative">
                    {form.imageUrl ? (
                  ...
                  <div className="flex-1 space-y-2">
                    <button
                      ...
                      className="inline-flex items-center gap-2 px-3.5 py-2 border border-gray-200 hover:border-primary-600 hover:text-primary-600 bg-white rounded text-xs font-bold text-gray-700 transition-colors shadow-2xs"
                    >
                    ...
                    <input
                      ...
                      className="w-full px-3 py-1.5 border border-gray-200 rounded-lg text-xs focus:border-primary-600 outline-none"
                    />
                  </div>
                </div>
              </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-3 border border-gray-200 rounded text-sm focus:border-primary-600 focus:ring-1 focus:ring-primary-500 outline-none resize-none"
              />
            </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {testimonials.length === 0 ? (
          <div className="col-span-full bg-white rounded p-12 text-center border border-gray-100">
            ...
            <button
              onClick={openCreate}
              className="inline-flex items-center gap-2 px-4 py-2 bg-primary-600 text-white font-bold rounded text-xs hover:bg-primary-700 transition-colors"
            >
              <Plus size={16} />
          ...
          testimonials.map(t => {
            ...
            return (
              <div
                key={t.id}
                className={`bg-white rounded p-5 border transition-all flex flex-col justify-between ${
              ...
              >
                <div>
                  ...
                  <div className="flex items-start gap-3.5 mb-3.5">
                    <div className="relative shrink-0">
                      {photoUrl ? (
                        <div className="w-14 h-14 rounded overflow-hidden ring-2 ring-primary-500/40 shadow-sm">
                          <img src={photoUrl} alt={t.name} className="w-full h-full object-cover" />
                        </div>
                      ) : (
                        <div className="w-14 h-14 rounded bg-gradient-to-br from-[#7a4b00] to-[#a36200] flex items-center justify-center text-white text-lg font-black shadow-sm ring-2 ring-primary-100">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="mt-1">
                        <span className="inline-block px-2.5 py-0.5 rounded-full text-[10px] font-black uppercase tracking-wider bg-primary-100 text-primary-600">
                          {t.course}
                        </span>
                      </div>
                    </div>
                ...
                <div className="pt-3 border-t border-gray-100 flex items-center justify-between">
                  <span className={`text-[11px] font-bold px-2 py-0.5 rounded-md ${t.isActive ? "bg-green-50 text-green-700" : "bg-surface-50 text-gray-500"}`}>
                  ...
                  <div className="flex items-center gap-1.5">
                    <button
                      ...
                      className={`p-1.5 rounded-lg text-xs font-semibold transition-colors ${
                        t.isActive ? "text-green-600 hover:bg-green-50" : "text-gray-400 hover:bg-surface-50"
                      }`}
